  ...
  <el-row class="tac">
    ...
    <el-tabs :tab-position="tabPosition" style="">
        <el-tab-pane label="动态">
            ...
            <el-col :span="16">
                <el-card class="box-card" shadow="hover" v-on:click="toPost(p1)" v-for="p1 in postList1" :key="p1.id">
                    ...
                    <div v-on:click="toPost(p1)">
                        {{p1.content}}
                    </div>
                    
                    <el-image style="height:auto;width:300px" :fit="fill" v-if="p1.img != null" :src="p1.img" v-on:click="toPost(p1)"></el-image>
                    <div class="form-inline" style="margin-top:5px" v-on:click="toPost(p1)">
